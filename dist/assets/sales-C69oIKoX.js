import{h as z}from"./html2canvas.esm-BfYXEYrK.js";import{e as R}from"./main-9l4h3B5c.js";let M=[],L=[],K=0,d=1;const _=10;let b="transaction",m="",g="",E="all";function gt(){console.log("✅ sales.ts 로드됨"),X(),tt(),et(),at(),ft(),b="transaction",Q(),$(),lt()}function X(){document.querySelectorAll('input[name="sales-type"]').forEach((t,e)=>{t.addEventListener("change",n=>{n.target.checked&&(b=e===0?"transaction":"product",d=1,nt(),b==="product"&&(Q(),W()),$())})})}function tt(){const o=document.querySelector('input[type="date"]:first-of-type'),t=document.querySelector('input[type="date"]:last-of-type'),e=document.querySelector(".btn-i.search"),n=document.querySelector(".btn-i.reset");o&&o.addEventListener("change",a=>{m=a.target.value}),t&&t.addEventListener("change",a=>{g=a.target.value}),e&&e.addEventListener("click",()=>{dt()&&(d=1,$())}),n&&n.addEventListener("click",()=>{W(),d=1,$()})}function et(){document.querySelectorAll('input[name="detail-period"]').forEach((t,e)=>{t.addEventListener("change",n=>{n.target.checked&&(ot(e),d=1,$())})})}function ot(o){const t=document.querySelector('input[type="date"]:first-of-type'),e=document.querySelector('input[type="date"]:last-of-type');if(!t||!e)return;const n=new Date;let a="",r="";switch(o){case 0:a="",r="";break;case 1:a=q(n),r=q(n);break;case 2:const u=new Date(n);u.setDate(n.getDate()-1),a=q(u),r=q(u);break;case 3:const c=new Date(n.getFullYear(),n.getMonth(),1),s=new Date(n.getFullYear(),n.getMonth()+1,0);a=q(c),r=q(s);break;case 4:const f=new Date(n.getFullYear(),n.getMonth()-1,1),S=new Date(n.getFullYear(),n.getMonth(),0);a=q(f),r=q(S);break}t.value=a,e.value=r,m=a,g=r}function nt(){const o=document.getElementById("table-header"),t=document.querySelector(".tableArea"),e=document.getElementById("date-search-section"),n=document.getElementById("detail-settings-section"),a=document.getElementById("payment-section");if(!o||!t){console.error("테이블 요소를 찾을 수 없습니다.");return}b==="transaction"?(o.innerHTML=`
    ...
    `,t.classList.remove("product-view"),e&&(e.style.display="flex"),n&&(n.style.display="block"),a&&(a.style.display="block")):(o.innerHTML=`
      ...
      <th>총주문액</th>
      <th>총건수</th>
    `,t.classList.add("product-view"),e&&(e.style.display="flex"),n&&(n.style.display="block"),a&&(a.style.display="none"))}async function $(){try{const t=JSON.parse(localStorage.getItem("userInfo")||"{}").userId;if(b==="transaction")await J(t),await st(t);else{await J(t);let e=`/model_payment?userId=${t}&func=get-menu-statistics`;m&&g&&(e+=`&startDate=${m}&endDate=${g}`),M=((await(await R(e)).json()).items||[]).sort((r,u)=>(u.totalCount||0)-(r.totalCount||0)),await Y(M)}}catch(o){console.error("매출 데이터 로드 실패:",o)}}async function J(o){try{let t=`/model_payment?func=get-payment&userId=${o}`;m&&g&&(t+=`&startDate=${m}&endDate=${g}`);const n=await(await R(t)).json();it(n)}catch(t){console.error("섹션 데이터 로드 실패:",t)}}function at(){document.querySelectorAll('input[name="payment-type"]').forEach((t,e)=>{t.addEventListener("change",n=>{if(n.target.checked){switch(e){case 0:E="all";break;case 1:E="card";break;case 2:E="point";break}d=1,$()}})})}async function st(o){try{let t=`/model_payment?func=get-payment&userId=${o}`;if(m&&g&&(t+=`&startDate=${m}&endDate=${g}`),E!=="all"&&(t+=`&paymentType=${E}`),d>1&&L.length>0){const a=d-2;L[a]&&(t+=`&lastEvaluatedKey=${encodeURIComponent(JSON.stringify(L[a]))}`)}const n=await(await R(t)).json();if(d===1&&(L=[],K=n.total||0,n.pageKeys))try{L=JSON.parse(n.pageKeys)}catch(a){console.error("pageKeys 파싱 실패:",a)}M=n.items||[],await Y(M)}catch(t){console.error("테이블 데이터 로드 실패:",t)}}function it(o){const t=document.querySelector(".countArea");if(t){const e=t.querySelectorAll(".countbox");if(e[0]){const n=e[0].querySelector("h4");if(n){const a=o.totalPriceSum||0;n.innerHTML=`${a.toLocaleString()}<small>원</small>`}}if(e[1]){const n=e[1].querySelector("h4");if(n){const a=o.totalCount||0;n.innerHTML=`${a}<small>건</small>`}}if(e[2]){const n=e[2].querySelector("h4");if(n){const a=o.pointSum||0;n.innerHTML=`${a}<small>P</small>`}}if(e[3]){const n=e[3].querySelector("h4");if(n){const a=o.pointCount||0;n.innerHTML=`${a}<small>건</small>`}}}}async function Y(o){const t=document.querySelector(".tableArea table tbody");t&&(t.innerHTML="",o.forEach((e,n)=>{var c;let a="";if(b==="transaction"){const s=String(e.timestamp).split("T"),f=s[0],S=s[1].substring(0,5),h=((c=e.menuSummary[0])==null?void 0:c.name)||"알 수 없음",v=e.menuSummary.reduce((w,l)=>w+(l.count||1),0),I=v>1?`<label class="plus">+${v-1}</label>`:"";a=`
        <td>${(d-1)*_+n+1}</td>
      ...
      `}const r=document.createElement("tr");r.className="on-popup";const u=b==="product"?n.toString():((d-1)*_+n).toString();r.setAttribute("data-index",u),r.innerHTML=a,t.appendChild(r)}),rt())}function rt(){const o=document.querySelector(".pagination");if(!o)return;if(b==="product"){o.style.display="none";return}o.style.display="block";const t=Math.ceil(K/_),e=o.querySelector(".page-numbers");e&&(e.innerHTML=""),o.querySelectorAll("button[data-page]").forEach(l=>l.remove());const a=5;let r=Math.max(1,d-Math.floor(a/2)),u=r+a-1;u>t&&(u=t,r=Math.max(1,u-a+1));for(let l=r;l<=u;l++){const p=document.createElement("button");p.setAttribute("data-page",String(l)),p.innerText=String(l),p.style.display="inline-block",p.style.margin="0 2px",p.style.padding="5px 10px",p.style.border="1px solid #ddd",p.style.backgroundColor=l===d?"#007bff":"#fff",p.style.color=l===d?"#fff":"#333",p.style.cursor="pointer",l===d&&p.classList.add("active"),p.addEventListener("click",()=>{l!==d&&(d=l,$())});const O=o.querySelector(".page-next");O?o.insertBefore(p,O):o.appendChild(p)}const c=o.querySelector(".page-first"),s=o.querySelector(".page-prev"),f=o.querySelector(".page-next"),S=o.querySelector(".page-last");c&&(c.style.display="inline-block"),s&&(s.style.display="inline-block"),f&&(f.style.display="inline-block"),S&&(S.style.display="inline-block"),[c,s,f,S].forEach(l=>{l&&l.replaceWith(l.cloneNode(!0))});const h=o.querySelector(".page-first"),v=o.querySelector(".page-prev"),I=o.querySelector(".page-next"),w=o.querySelector(".page-last");h&&(h.addEventListener("click",()=>{d>1&&(d=1,$())}),h.disabled=d===1),v&&(v.addEventListener("click",()=>{d>1&&(d--,$())}),v.disabled=d===1),I&&(I.addEventListener("click",()=>{d<t&&(d++,$())}),I.disabled=d===t),w&&(w.addEventListener("click",()=>{d<t&&(d=t,$())}),w.disabled=d===t)}function lt(){const o=document.querySelector(".popup-overlay");document.addEventListener("click",t=>{const e=t.target;if(e.closest(".on-popup")){const n=e.closest(".on-popup"),a=parseInt(n.getAttribute("data-index")||"0");ct(a),o.style.display="flex"}e.closest(".save-img")&&pt(),(e.closest(".popup-footer .gr")||e.closest(".close-btn"))&&(o.style.display="none")})}async function ct(o){var t,e,n,a,r,u;try{let c,s;if(b==="product"?(c=o,s=M[c]):(c=o%_,s=M[c]),console.log("item",s),!s){console.error("해당 인덱스의 데이터를 찾을 수 없습니다:",c);return}const S=JSON.parse(localStorage.getItem("userInfo")||"{}").userId;let h={storeName:"정보 없음",tel:"정보 없음",address:"정보 없음",businessNo:"정보 없음"};try{const p=await(await R(`/model_user_setting?func=get-user&userId=${S}`)).json();p&&p.user&&(h={storeName:p.user.storeName||"정보 없음",tel:p.user.tel||"정보 없음",address:p.user.address||"정보 없음",businessNo:p.user.businessNo||"정보 없음"})}catch(l){console.error("매장 정보 로드 실패:",l)}let v="";if(b==="transaction"){const l=s.menuSummary.map(N=>`${N.name} / ${N.count||1}개`).join("<br>"),p=String(s.timestamp).split("T"),O=p[0],V=p[1].substring(0,5),F=`${O} ${V}`;if(s.totalPayInfo){const C=`
            ...
            `,x=((e=s.totalPayInfo)==null?void 0:e.filter(i=>i.method==="카드"))||[];let P="미사용",T="미사용",H="-";if(x.length>0){P=x.map(D=>`${D.method} (${D.issuerName})`).join(", "),T=x.map(D=>D.cardBin).join(", ");const i=(n=x[0])==null?void 0:n.approvalDateTime;if(i){const[D,G]=i.split("T"),Z=G.split("+")[0].substring(0,5);H=`${D} ${Z}`}}const k=(a=s.totalPayInfo)==null?void 0:a.filter(i=>i.method==="바코드QR").flatMap(i=>i||{});k.length>0&&(P=k.map(i=>`${i.method} (${i.payName})`),T=k.map(i=>`${i.cardBin}`));const j=((r=s.totalPayInfo)==null?void 0:r.filter(i=>i.method==="마일리지"&&i.usedAmount>0))||[];let U="미등록 고객",A="미사용";j.length>0&&(U=j.map(i=>`${i.mileageNo??"-"}`).join(", "),A=j.map(i=>`${i.usedAmount.toLocaleString()}`).join(", "));const y=`
                    <div>
                        <h5>결제 수단</h5>
                        <p>${P}</p>
                    </div>
                ...
                `}else{const N=s.point===0?"0P":`${s.point}P`;let C="card",x="카드",P="정보 없음",T="정보없음";s.point>0&&(C="point",x="포인트"),s.pointData&&(P=s.pointData.tel||"정보 없음",T=`${s.pointData.points||0}P`);let H="",k="";if(C==="card"){const y=s.payInfo||{},B=y.issuerName||"정보 없음",i=y.cardBin||"정보 없음";H=`
                        <div>
                            <h5>결제 카드</h5>
                            <p>${B}</p>
                        </div>
